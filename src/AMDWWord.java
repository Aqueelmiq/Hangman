...
public class AMDWWord {
	...
	public AMDWWord(String word,String type,String explanation,int category) {
	...
	public AMDWWord(String currentWord, int wordLength, int wordDiff, String wordCat, String wordType, String wordDef) {
	...
	public AMDWWord(String currentWord, int wordDiff, int wordCat, String wordType, String wordDef) {
		this.wordContent=currentWord;
	...
	public boolean equals(Object obj){
		if(obj instanceof AMDWWord){
			if(this.wordContent.compareTo(((AMDWWord) obj).getWord())==0)
				return true;
			else
				return false;
		}
	...
	public int compareTo(AMDWWord myWord){
