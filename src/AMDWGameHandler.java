...
public class AMDWGameHandler {
	
	private static AMDWObjectArray wordArr;
	...
	public static void playMainGame(int difficulty, AMDWObjectArrayAdvanced arr) {
		
		wordArr = arr;
		wordArr.sort(); //Stores and sorts the word-list
		int random = (int) (((difficulty-1)*wordArr.getIndex()/3) + Math.random()*wordArr.getIndex()/3);
		AMDWWord myWord = ((AMDWWord)wordArr.getAtPos(random));
		AMDWGame hangman = new AMDWGame(myWord, difficulty);
	...
	public static void playVersusGame(int difficulty, AMDWObjectArrayAdvanced arr) {
		
		wordArr = arr;
		wordArr.sort();
		//Stores and sorts the words
		int random = (int) (((difficulty-1)*wordArr.getIndex()/3) + Math.random()*wordArr.getIndex()/3);
		AMDWWord myWord = ((AMDWWord)wordArr.getAtPos(random)), myWord2 = ((AMDWWord)wordArr.getAtPos(random+1));
		AMDWVersusGame hangman2 = new AMDWVersusGame(myWord, myWord2, difficulty);
